 ...
 * <code>Id</code> annotation is applied should be one of the following types: any Java
 * primitive type; any primitive wrapper type; <code>String</code>;
 ...
 * the primary table. If no <code>Column</code> annotation is specified, the primary key
 * column name is assumed to be the name of the primary key property or field.
 * 
 * <pre>
 *   Example:
 * 
